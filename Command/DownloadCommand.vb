...
Public Class DownloadCommand
    ...
    Public savetarget As String = "hello"
    Private stringgiven As Boolean = False
    ...
    Public Sub New(ByVal inModel As CameraModel, ByVal dirItem As IntPtr, ByVal namein As String)
        MyBase.New(inModel)
        Me.directoryItem = dirItem
        savetarget = namein
        stringgiven = True
    ...
    Public Overrides Function execute() As Boolean
        ...
        ' Modifications: Change destination file name.
        dirItemInfo.szFileName = VBSample.savepath


        'Console.WriteLine("FromDownload: " & VBSample.savepath)
